...
PGPASSWORD=$SU_USER_PWD psql --username=$SU_USER --host=$DB_SERVERIP --port=$DB_PORT --dbname=$DEFAULT_DB_NAME -f role_registrationrepouser.sql -v dbuserpwd=\'$DBUSER_PWD\'
